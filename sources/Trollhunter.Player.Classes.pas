...
const
dsRanger = 'Стрелки - отважные воины, предпочитающие дистанционную атаку. Они мастерски расстреливают врагов издалека. Основная задача стрелка - не подпустить врага к себе на расстояние удара.';
