...
procedure TMap.AddTiles(AX, AY: UInt; AZ: TMapEnum; AType: UInt;
  ADen: UInt; ABaseTileEnum, ATileEnum: TTileEnum);
var
  K, X, Y: UInt;
  Z: TMapEnum;
...
const
  ...
  procedure AddRect(AX, AY, AW, AH: UInt; AFloorTileEnum, AWallTileEnum: TTileEnum;
    IsFog: boolean = False);
  var
    X, Y: UInt;
    PX, PY: UInt;
