...
const
  ItemBase: array [TItemEnum] of TItemBase = (
    ...
    MaxDurability: 0; Level: 1; Defense: (Min: 0; Max: 0);
    Damage: (MinDamage: (Min: 0; Max: 0; ); MaxDamage: (Min: 0; Max: 0; ));
    Price: 400; Color: clLightestBlue; Deep: [deDark_Wood .. deDrom];
    Effects: [efDisenchant]; Value: 0; ManaCost: 30; ),
    ...
    // Short Bow
    (Symbol: ')'; ItemType: itBow; SlotType: stRanged; MaxStack: 1;
    MaxDurability: 35; Level: 1; Defense: (Min: 0; Max: 0);
    Damage: (MinDamage: (Min: 1; Max: 2; ); MaxDamage: (Min: 3; Max: 4; ));
    ...
    MaxDurability: 0; Level: 3; Defense: (Min: 0; Max: 0);
    Damage: (MinDamage: (Min: 0; Max: 0; ); MaxDamage: (Min: 0; Max: 0; ));
    Price: 380; Color: clLightestBlue; Deep: [deGray_Cave];
    ...
    MaxDurability: 0; Level: 7; Defense: (Min: 0; Max: 0);
    Damage: (MinDamage: (Min: 0; Max: 0; ); MaxDamage: (Min: 0; Max: 0; ));
    Price: 460; Color: clLightBlue; Deep: [deBlood_Cave]; ),
    // Divine
    (Symbol: '?'; ItemType: itBook; SlotType: stNone; MaxStack: 1;
    MaxDurability: 0; Level: 7; Defense: (Min: 0; Max: 0);
    Damage: (MinDamage: (Min: 0; Max: 0; ); MaxDamage: (Min: 0; Max: 0; ));
    Price: 550; Color: clBlue; Deep: [deBlood_Cave]; ),
    // Nature
    (Symbol: '?'; ItemType: itBook; SlotType: stNone; MaxStack: 1;
    MaxDurability: 0; Level: 7; Defense: (Min: 0; Max: 0);
    Damage: (MinDamage: (Min: 0; Max: 0; ); MaxDamage: (Min: 0; Max: 0; ));
    Price: 650; Color: clDarkBlue; Deep: [deBlood_Cave]; ),
    // Shadow
    (Symbol: '?'; ItemType: itBook; SlotType: stNone; MaxStack: 1;
    MaxDurability: 0; Level: 7; Defense: (Min: 0; Max: 0);
    Damage: (MinDamage: (Min: 0; Max: 0; ); MaxDamage: (Min: 0; Max: 0; ));
    Price: 570; Color: clLightestBlue; Deep: [deBlood_Cave]; ),
    // Elemental
    (Symbol: '?'; ItemType: itBook; SlotType: stNone; MaxStack: 1;
    MaxDurability: 0; Level: 7; Defense: (Min: 0; Max: 0);
    Damage: (MinDamage: (Min: 0; Max: 0; ); MaxDamage: (Min: 0; Max: 0; ));
    Price: 600; Color: clLightBlue; Deep: [deBlood_Cave]; ),
    // Arcane
    (Symbol: '?'; ItemType: itBook; SlotType: stNone; MaxStack: 1;
    MaxDurability: 0; Level: 9; Defense: (Min: 0; Max: 0);
    Damage: (MinDamage: (Min: 0; Max: 0; ); MaxDamage: (Min: 0; Max: 0; ));
    Price: 700; Color: clBlue; Deep: [deDrom]; ),
    // Divine
    (Symbol: '?'; ItemType: itBook; SlotType: stNone; MaxStack: 1;
    MaxDurability: 0; Level: 9; Defense: (Min: 0; Max: 0);
    Damage: (MinDamage: (Min: 0; Max: 0; ); MaxDamage: (Min: 0; Max: 0; ));
    Price: 680; Color: clDarkBlue; Deep: [deDrom]; ),
    // Nature
    (Symbol: '?'; ItemType: itBook; SlotType: stNone; MaxStack: 1;
    MaxDurability: 0; Level: 9; Defense: (Min: 0; Max: 0);
    Damage: (MinDamage: (Min: 0; Max: 0; ); MaxDamage: (Min: 0; Max: 0; ));
    Price: 720; Color: clLightestBlue; Deep: [deDrom]; ),
    // Shadow
    (Symbol: '?'; ItemType: itBook; SlotType: stNone; MaxStack: 1;
    MaxDurability: 0; Level: 9; Defense: (Min: 0; Max: 0);
    Damage: (MinDamage: (Min: 0; Max: 0; ); MaxDamage: (Min: 0; Max: 0; ));
    Price: 750; Color: clLightBlue; Deep: [deDrom]; ),
    // Elemental
    (Symbol: '?'; ItemType: itBook; SlotType: stNone; MaxStack: 1;
    MaxDurability: 0; Level: 9; Defense: (Min: 0; Max: 0);
    Damage: (MinDamage: (Min: 0; Max: 0; ); MaxDamage: (Min: 0; Max: 0; ));
    Price: 800; Color: clBlue; Deep: [deDrom]; ),
    }
    // Viper Toxin
    ...
    MaxDurability: 0; Level: 4; Defense: (Min: 0; Max: 0);
    Damage: (MinDamage: (Min: 0; Max: 0; ); MaxDamage: (Min: 0; Max: 0; ));
    Price: 140; Color: clDarkYellow; Deep: [deDeep_Cave .. deBlood_Cave];
    Effects: [efPoisonWeapon]; Value: 35; ),
    // Spider Venom
    (Symbol: '!'; ItemType: itVenom; SlotType: stNone; MaxStack: 20;
    MaxDurability: 0; Level: 5; Defense: (Min: 0; Max: 0);
    Damage: (MinDamage: (Min: 0; Max: 0; ); MaxDamage: (Min: 0; Max: 0; ));
...
type
  ...
  public
    ...
    procedure AddItemToInv(AItemEnum: TItemEnum; AAmount: UInt = 1;
      EqFlag: boolean = False; IdFlag: boolean = False; SufID: UInt = 0); overload;
...
begin
  ...
  // Level
  if (AItem.Level > Player.Attributes.Attrib[atLev].Value) or not
    Game.GetOption(apHdLevOfItem) then
  ...
  begin
    ...
    // Durability
    D := '';
    if IT in SmithTypeItems + QuiverTypeItems then
    begin
  ...
  begin
    ...
    if IsManyItems then
    begin
      Result := Format('Several items (%dx) are lying here (%s).', [ACount, S]);
    end
    else
      Result := Format('%s is lying here.', [S]);
  end;
...
begin
  ...
  if (AItem.Stack = 1) and (ItemBase[TItemEnum(ID)].Defense.Min > 0) then
    AItem.Defense := Math.EnsureRange(Math.RandomRange(
      ItemBase[TItemEnum(ID)].Defense.Min, ItemBase[TItemEnum(ID)].Defense.Max + 1),
      1, UIntMax)
  else
    AItem.Defense := 0;
  // Damage
  ...
  // Durability
  if (AItem.Stack = 1) then
    AItem.MaxDurability := Math.EnsureRange(Math.RandomRange(
      ItemBase[TItemEnum(ID)].MaxDurability - 5, ItemBase[TItemEnum(ID)].MaxDurability +
      6), 10, UIntMax)
  else
...
begin
  ...
  begin
    ...
    if (ItemBase[TItemEnum(FItem.ItemID)].ItemType in CorpseTypeItems) then
      if (Items_Dungeon_DeleteMapItemXY(AItem.MapID, I, AItem.X,
        AItem.Y, FItem) > 0) then
