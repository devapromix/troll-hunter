...
const
  RaceProp: array [TRaceEnum] of TRaceProp = (
    // Human
    (Description: 'Humans are the most common of races.'; Age: (Min: 18; Max: 50;); Height: (Min: 160; Max: 180;);
    ...
    // Elf
    (Description: 'Elf'; Age: (Min: 75; Max: 800;); Height: (Min: 190; Max: 250;);
    ...
    // Gnome
    (Description: 'Gnome'; Age: (Min: 20; Max: 160;); Height: (Min: 90; Max: 130;);
    Weight: (Min: 70; Max: 110;); Metabolism: (Min: 95; Max: 100;);
    Strength: (Min: 1; Max: 2;); Dexterity: (Min: 1; Max: 2;);
    Willpower: (Min: 1; Max: 3;); Perception: (Min: 1; Max: 3;);
    Life: (Min: 5; Max: 10;); Mana: (Min: 10; Max: 15;);),
    // Dwarf
    (Description: 'Dwarf'; Age: (Min: 20; Max: 250;); Height: (Min: 100; Max: 150;);
